...
public class Ejercicio3 {
	...
	public static void main(String[] args) {
		 ...
		 * A continuación, crea una variable String con valor inicial -mundo-. Muestra por pantalla las cuatro variables de tipo primitivo y 
		 * por detrás la variable String. */
