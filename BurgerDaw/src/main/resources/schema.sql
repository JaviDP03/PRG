...
CREATE TABLE INCORPORA (
	...
	CONSTRAINT FK1_INCORPORA FOREIGN KEY (IDH) REFERENCES HAMBURGUESA (ID) ON DELETE CASCADE,
	CONSTRAINT FK2_INCORPORA FOREIGN KEY (IDI) REFERENCES INGREDIENTE (ID) ON DELETE CASCADE
);
